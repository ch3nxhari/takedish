...
class DetailPage extends Page {
  ...
  showLoadingInSubmitButton(isShown = true) {
    const loadingIndicator = getElement('.btn_loading');
  ...
  showNewReviews(customerReviews) {
    const restaurantReviewElement = getElement('restaurant-review');
    restaurantReviewElement.reRenderReviewElement(customerReviews);
  }
