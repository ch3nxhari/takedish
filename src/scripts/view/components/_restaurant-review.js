import accountIcon from '../../../public/images/icons/account_profile.svg';
...
class RestaurantReview extends HTMLElement {
  ...
  _renderReviewItem({name, review, date}) {
    return /* html */`
   <li class="review_item" role="listitem">
    <img
      src="${accountIcon}"
      ...
      role="img"
      aria-label="Foto dari akun ${name}"
    >
    <div class="review_content">
      <p class="review_name">${name}</p>
      <p class="review_date" aria-label="Tanggal review">${date}</p>
      <p>${review}</p>
    </div>
  </li>
  `;
