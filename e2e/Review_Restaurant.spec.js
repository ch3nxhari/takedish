...
Before(({I}) => {
  ...
  I.click(locate('.restaurant_name').at(3));
});

Scenario('Reviewing a Restaurant', async ({I}) => {
  // Dummy data
  const nameOfReviewer = `Gilang`;
  const reviewContent = `Saya sangat suka menu malamnya!`;
