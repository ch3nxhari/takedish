...
describe('Restaurant Detail Element', () => {
  ...
  beforeEach(() =>{
    document.body.innerHTML = '<restaurant-details></restaurant-details>';
    restaurantDetailElement = document.querySelector('restaurant-details');
  });
  ...
  describe('When restaurant details data is set', () => {
    ...
    it('should show restaurants detail content', () => {
      ...
      expect(restaurantDetailElement.querySelector('.main-info'))
          .toBeTruthy();
      expect(restaurantDetailElement.querySelector('restaurant-review'))
          .toBeTruthy();
    });
  });
});
